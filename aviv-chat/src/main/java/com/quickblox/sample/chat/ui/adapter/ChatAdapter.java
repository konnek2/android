...
public class ChatAdapter extends BaseListAdapter<QBChatMessage> implements StickyListHeadersAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.messageContainerLayout = (RelativeLayout) convertView.findViewById(R.id.layout_chat_message_container);
            ...
            holder.imageViewTickStatus = (ImageView) convertView.findViewById(R.id.image_view_message_status1);
...
//        Log.d("CHATFRAGMENT", "   ChatAdapter   showMessage  message== " + chatMessage);
...
//                    Log.d("CHATFRAGMENT", "   ChatAdapter   messageContainerLayout " + chatMessage);
...
//                Log.d("CHATFRAGMENT", "   ChatAdapter   messageContainerLayout ");
//                if (hasAttachments(chatMessage)) {
//                    toggleItemInfo(holder, position);
//                    return true;
//                }
...
//            Log.d("CHATFRAGMENT", "   ChatAdapter   isIncoming   isRead  ");
...
//        Log.d("CHATFRAGMENT", "   ChatAdapter  setIncomingOrOutgoingMessageAttributes  " + chatMessage);
        boolean isIncoming = isIncoming(chatMessage);
//        Log.d("CHATE_FLAGE_CHECK", " : " + isIncoming);
        ...
        if (isIncoming) {
            holder.imageViewTickStatus.setVisibility(View.GONE);
        } else {
            int serverStatus = App.messageStatusTableDAO.getSurveyStatus(chatMessage.getId());
            int deliverStatus = App.messageStatusTableDAO.getDeliveryStatus(chatMessage.getId());
            int readStatus = App.messageStatusTableDAO.getReadStatus(chatMessage.getId());
            if (serverStatus == 1 && deliverStatus == 0 && readStatus == 0) {
                holder.imageViewTickStatus.setVisibility(View.VISIBLE);
                holder.imageViewTickStatus.setImageDrawable(context.getResources().getDrawable(R.drawable.ic_chat_single_tick));
            }
            if (serverStatus == 1 && deliverStatus == 1) {
                holder.imageViewTickStatus.setVisibility(View.VISIBLE);
                holder.imageViewTickStatus.setImageDrawable(context.getResources().getDrawable(R.drawable.ic_chat_double_tick));
            }
            if (serverStatus == 1 && deliverStatus == 1 && readStatus == 1) {

                holder.imageViewTickStatus.setVisibility(View.VISIBLE);
                holder.imageViewTickStatus.setImageDrawable(context.getResources().getDrawable(R.drawable.ic_chat_double_tick_blue));
    ...
    private static class ViewHolder {
        ...
        public RelativeLayout messageContainerLayout;
        ...
        public ImageView imageViewTickStatus;
    }
